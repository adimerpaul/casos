        ...
        <div class="card-body">
            <form method="post" action="{{route('login')}}">
                ...
                <div class="form-group">
                    <input class="form-control @error('email') is-invalid @enderror form-control-lg"   id="username" type="email" placeholder="Username" autocomplete="off" name="email" autofocus value="{{old('email')}}">
                    @error('email')
                    <span class="badge badge-danger p-0" style="display: block">
